...
**Examcat** 是一个现代化的多题库在线考试系统，基于 Flask 框架开发，项目开发初衷是补充 *医考帮* 不能刷历年题的遗憾。本项目源于 [EXAM-MASTER](https://github.com/ExamMaster/EXAM-MASTER)，但经过全面重构和优化，提供了更完善的功能和更好的用户体验。项目配置了 [artalk](https://artalk.js.org/zh/guide/intro.html) 的在线评论系统；同时，项目现已全面支持 `ajax` 页面刷新，浏览体验~~如德芙般丝滑~~。

这是我的第一个全栈项目（绝不是最后一个），花了我相当多的心血。在考试和课程夹缝之间，我最终还是爬过了这座巨大的山。

如果你也想实现一个自己的想法，从零开始真的可以吗？我的回答是：
...
```csv
"题号","题干","A","B","C","D","E","答案","题型"
"1","毛泽东思想产生的社会历史条件有()。","十月革命开辟的世界无产阶级革命的新时代","近代中国社会矛盾和革命运动的发展","工人阶级队伍壮大及工人运动的发展","中国共产党领导的中国新民主主义革命的伟大实践","","ABCD","多选题"
"2","毛泽东思想的科学含义是()。","是马克思列宁主义在中国的运用和发展","是被实践证明了的关于中国革命的正确的理论原则和经验总结","是中国共产党集体智慧的结晶","建设中国特色社会主义的理论","","ABC","多选题"
"3","毛泽东思想的活的灵魂是()。","群众路线","独立自主","实事求是","理论与实际相结合","","ABC","多选题"
```
